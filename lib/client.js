        ...
        h(
          ...
          h(
            "select",
            {
              ...
              value: pluginSettings.contextLength || "2",
              onChange: function (e) { setPluginSetting("contextLength", e.target.value); },
            },
          ...
          h("div", { className: "dss-set-hint" }, "控制临时会话能看到的对话条数与文件内容上限；改完即时生效。")
        ),
        mode === "2"
          ? h(
              "div",
